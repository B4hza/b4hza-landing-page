    ...
    <>
      ...
      <header className="relative z-10 bg-[#f5f5f5] px-6 py-4">
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Link href="#lista" className="bg-black text-white hover:bg-gray-800 rounded-xl px-4 py-2 flex items-center space-x-2">
      ...
      <div className="fixed top-0 inset-x-0 z-20 md:hidden bg-white border-b border-gray-200 px-6 py-4 mb-4">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          ...
          <Link href="#lista" className="bg-black text-white hover:bg-gray-800 rounded-2xl px-5 py-3 flex items-center">
